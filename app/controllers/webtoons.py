        ...
        if (self.image_viewer.webtoon_mode and
            ...
            try:
                ...
                if file_path in self.image_states:
                    ...
                    # The image controller also preserves the sticky manual OCR
                    # source-language choice used in regular page mode.
                    self.main.image_ctrl.restore_page_languages(state)
